...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/asdfghjkl-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14453&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/asdfghjkl-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `asdfghjkl` can be installed with:

```
conda install asdfghjkl
```

It is possible to list all of the versions of `asdfghjkl` available on your platform with:
